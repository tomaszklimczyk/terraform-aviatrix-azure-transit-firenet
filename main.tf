...
resource "aviatrix_firewall_instance" "firewall_instance" {
  ...
  management_subnet      = local.is_paloalto ? aviatrix_vpc.default.subnets[2].cidr : null
}
...
resource "aviatrix_firewall_instance" "firewall_instance_2" {
  ...
  username               = local.is_checkpoint ? "admin" : var.firewall_username
  password               = var.firewall_password
  management_subnet      = local.is_paloalto ? aviatrix_vpc.default.subnets[3].cidr : null
}
